...
def obtener_cuotas():
    ...
    cuotas_manuales = {
        ...
        # ── Cuartos de final ──
        ('Francia',     'Marruecos'):           {'c1':1.56,'cx':3.90,'c2':6.25,'hc':{},
        ...
        ('Noruega',     'Inglaterra'):          {'c1':3.90,'cx':3.65,'c2':1.93,'hc':{
                'nor_+0.5':1.93,'nor_+1.0':1.50,'ing_-0.5':1.91,'ing_-1.0':2.70},
            'totals':{
                'over_1.5':1.24,'under_1.5':4.10,
                'over_2.5':1.72,'under_2.5':2.12,
                'over_3.5':2.72,'under_3.5':1.47,
                'nor_over_0.5':1.37,'nor_over_1.5':2.72,'nor_over_2.5':6.20,
                'nor_under_1.5':1.42,
                'ing_over_0.5':1.17,'ing_over_1.5':1.80,'ing_over_2.5':3.35,
                'ing_under_1.5':1.95,
                'remates_over_23.5':1.47,'remates_over_24.5':1.65,'remates_over_25.5':1.88,
                'remates_under_23.5':2.57,
                'tiros_over_8.5':1.60,'tiros_over_9.5':2.00,'tiros_over_10.5':2.62,
                'tiros_under_8.5':2.25,'tiros_under_9.5':1.75,
                'nor_tiros_over_2.5':1.30,'nor_tiros_over_3.5':1.72,'nor_tiros_over_4.5':2.57,
                'ing_tiros_over_4.5':1.50,'ing_tiros_over_5.5':1.98,'ing_tiros_over_6.5':2.82,
                'ing_tiros_under_5.5':1.78,
                'tarjetas_over_1.5':1.28,'tarjetas_over_2.5':1.72,'tarjetas_over_3.5':2.55,
                'tarjetas_under_2.5':2.05,'tarjetas_under_3.5':1.47,
                'faltas_over_20.5':1.67,'faltas_over_21.5':1.91,'faltas_over_22.5':2.25,
                'faltas_under_20.5':2.12,
                'nor_faltas_over_9.5':1.31,'nor_faltas_over_10.5':1.52,
                'ing_faltas_over_7.5':1.28,'ing_faltas_over_8.5':1.50,'ing_faltas_over_9.5':1.82,
                'primera_mit_over_0.5':1.39,'primera_mit_over_1.5':2.65,
            },
            'btts_si':1.60,'btts_no':2.25,
            'corners':{
                'over_8.5':1.47,'under_8.5':2.57,
                'over_9.5':1.80,'under_9.5':1.95,
                'over_10.5':2.32,'under_10.5':1.57,
            }},
        ('España',      'Bélgica'):             {'c1':1.67,'cx':3.95,'c2':5.40,'hc':{
                'esp_-0.5':1.67,'esp_-1.0':2.18,'esp_-1.5':2.85},
            'totals':{'over_1.5':1.27,'under_1.5':3.80,'over_2.5':1.82,'under_2.5':2.02,
                      'over_3.5':2.95,'under_3.5':1.40,
                      'esp_over_1.5':1.83,'esp_over_5.5_tiros':1.80,
                      'esp_over_13.5_remates':1.87,'esp_over_14.5_remates':1.90,
                      'over_3.5_tarjetas':1.38,'over_4.5_tarjetas':1.80},
            'btts_si':1.78,'btts_no':1.98,
            'corners':{'over_8.5':1.52,'under_8.5':2.42,'over_9.5':1.87,'under_9.5':1.87,
                       'over_10.5':2.42,'under_10.5':1.52},
            'primera_mitad':{'esp_gana_1t':2.28}},
        ('Francia',     'Inglaterra'):          {'c1':1.93,'cx':0,'c2':3.65,'hc':{
                'fra_-1':3.15,'fra_+1':1.30,'ing_+1':1.95,'ing_-1':7.70},
            'totals':{
                'over_0.5':1.03,'over_1.5':1.15,'over_2.5':1.47,'over_3.5':2.10,
                'under_1.5':5.60,'under_2.5':2.72,'under_3.5':1.75,
                'fra_over_0.5':1.11,'fra_over_1.5':1.57,'fra_under_1.5':2.30,
                'ing_over_0.5':1.27,'ing_over_1.5':2.20,'ing_under_1.5':1.62,
                'primera_mit_over_0.5':1.28,'primera_mit_over_1.5':2.15,
                'remates_over_20.5':1.17,'remates_over_21.5':1.25,'remates_over_22.5':1.35,
                'remates_over_23.5':1.50,'remates_over_24.5':1.70,
                'fra_rem_over_10.5':1.15,'fra_rem_over_11.5':1.25,'fra_rem_over_12.5':1.40,
                'fra_rem_over_13.5':1.62,'fra_rem_over_14.5':1.95,
                'ing_rem_over_7.5':1.14,'ing_rem_over_8.5':1.26,'ing_rem_over_9.5':1.45,
                'ing_rem_over_10.5':1.75,
                'tiros_over_6.5':1.12,'tiros_over_7.5':1.23,'tiros_over_8.5':1.42,
                'fra_tiros_over_3.5':1.18,'fra_tiros_over_4.5':1.42,'fra_tiros_over_5.5':1.83,
                'ing_tiros_over_2.5':1.20,'ing_tiros_over_3.5':1.50,'ing_tiros_over_4.5':2.07,
                'tarjetas_over_1.5':1.34,'tarjetas_over_2.5':1.87,
                'faltas_over_18.5':1.26,'faltas_over_19.5':1.37,'faltas_over_20.5':1.52,
                'fra_tar_over_0.5':1.13,'fra_tar_over_1.5':1.60,
                'ing_tar_over_0.5':1.27,'ing_tar_over_1.5':2.20,
                'penales_si':7.00,'penales_no':1.10,'prorroga_si':6.00,
            },
            'btts_si':1.42,'btts_no':2.72,
            'corners':{
                'over_6.5':1.17,'under_6.5':4.55,'over_7.5':1.34,'under_7.5':3.10,
                'over_8.5':1.62,'under_8.5':2.25,'over_9.5':2.02,'under_9.5':1.75,
                'fra_over_2.5':1.33,'fra_over_3.5':1.78,'fra_over_4.5':2.67,
                'ing_over_2.5':1.27,'ing_over_3.5':1.67,'ing_over_4.5':2.45,
            }},
        ('Argentina',   'Suiza'):              {'c1':1.75,'cx':3.50,'c2':5.30,'hc':{
                'arg_0.0':1.29,'arg_-0.5':1.75,'arg_-1.0':2.37,
                'sui_+0.5':2.15,'sui_+1.0':1.62},
            'totals':{
                'over_1.5':1.40,'under_1.5':2.95,
                'over_2.5':2.18,'under_2.5':1.70,
                'over_3.5':3.90,'under_3.5':1.26,
                'arg_over_0.5':1.21,'arg_over_1.5':1.95,'arg_over_2.5':3.90,
                'arg_under_1.5':1.78,
                'sui_over_0.5':1.70,'sui_over_1.5':4.20,
                'sui_under_0.5':2.07,'sui_under_1.5':1.20,
                'remates_over_20.5':1.65,'remates_over_21.5':1.91,'remates_over_22.5':2.27,
                'remates_under_20.5':2.15,
                'tiros_over_7.5':1.55,'tiros_over_8.5':1.95,'tiros_over_9.5':2.57,
                'tiros_under_7.5':2.35,'tiros_under_8.5':1.80,
                'arg_tiros_over_4.5':1.45,'arg_tiros_over_5.5':1.90,'arg_tiros_over_6.5':2.67,
                'arg_tiros_under_5.5':1.85,
                'sui_tiros_over_1.5':1.24,'sui_tiros_over_2.5':1.72,'sui_tiros_over_3.5':2.72,
                'sui_tiros_under_2.5':2.05,
                'tarjetas_over_1.5':1.23,'tarjetas_over_2.5':1.62,'tarjetas_over_3.5':2.35,
                'tarjetas_under_2.5':2.20,'tarjetas_under_3.5':1.55,
                'faltas_over_22.5':1.65,'faltas_over_23.5':1.87,'faltas_over_24.5':2.15,
                'faltas_under_22.5':2.15,
                'arg_faltas_over_10.5':1.44,'arg_faltas_over_11.5':1.72,
                'sui_faltas_over_10.5':1.57,'sui_faltas_over_11.5':1.90,
                'primera_mit_over_0.5':1.52,'primera_mit_over_1.5':3.20,
                'asiatico_over_2.0':1.67,'asiatico_over_2.5':2.22,
            },
            'btts_si':2.02,'btts_no':1.75,
            'corners':{
                'over_7.5':1.57,'under_7.5':2.30,
                'over_8.5':2.05,'under_8.5':1.72,
                'over_9.5':2.72,'under_9.5':1.42,
            }},
        ('Argentina',   'Inglaterra'):          {'c1':2.77,'cx':3.40,'c2':3.10,'hc':{
                'arg_-1':7.30,'arg_+1':1.50,'arg_+2':1.14,
                'ing_-1':6.00,'ing_+1':1.40,'ing_+2':1.11},
            'totals':{
                'over_0.5':1.11,'over_1.5':1.44,'over_2.5':2.30,'over_3.5':4.10,
                'under_0.5':6.70,'under_1.5':2.82,'under_2.5':1.62,'under_3.5':1.24,
                'arg_over_0.5':1.39,'arg_over_1.5':2.87,'arg_under_1.5':1.39,
                'ing_over_0.5':1.36,'ing_over_1.5':2.65,'ing_under_1.5':1.44,
                'primera_mit_over_0.5':1.57,'primera_mit_over_1.5':3.30,
                'primera_mit_under_0.5':2.35,'primera_mit_under_1.5':1.32,
                'remates_over_17.5':1.25,'remates_over_18.5':1.37,'remates_over_19.5':1.53,
                'remates_over_20.5':1.75,'remates_over_21.5':2.07,
                'remates_under_19.5':2.40,'remates_under_20.5':2.00,
                'arg_rem_over_7.5':1.22,'arg_rem_over_8.5':1.40,'arg_rem_over_9.5':1.67,
                'arg_rem_over_10.5':2.12,'arg_rem_under_10.5':1.67,
                'ing_rem_over_7.5':1.15,'ing_rem_over_8.5':1.27,'ing_rem_over_9.5':1.47,
                'ing_rem_over_10.5':1.78,'ing_rem_under_10.5':1.98,
                'tiros_over_4.5':1.11,'tiros_over_5.5':1.25,'tiros_over_6.5':1.47,
                'tiros_over_7.5':1.87,'tiros_over_8.5':2.50,
                'tiros_under_6.5':2.25,'tiros_under_7.5':1.87,'tiros_under_8.5':1.50,
                'arg_tiros_over_1.5':1.12,'arg_tiros_over_2.5':1.37,'arg_tiros_over_3.5':1.90,
                'arg_tiros_under_3.5':1.85,
                'ing_tiros_over_1.5':1.08,'ing_tiros_over_2.5':1.26,'ing_tiros_over_3.5':1.65,
                'ing_tiros_under_3.5':2.15,
                'tarjetas_over_1.5':1.11,'tarjetas_over_2.5':1.31,'tarjetas_over_3.5':1.67,
                'tarjetas_over_4.5':2.32,'tarjetas_under_3.5':2.10,'tarjetas_under_4.5':1.57,
                'arg_tar_over_0.5':1.13,'arg_tar_over_1.5':1.60,'arg_tar_under_1.5':2.25,
                'ing_tar_over_0.5':1.12,'ing_tar_over_1.5':1.53,'ing_tar_under_1.5':2.40,
                'penales_si':4.50,'penales_no':1.21,
                'prorroga_si':5.20,'prorroga_no':1.14,
            },
            'btts_si':1.83,'btts_no':1.91,
            'corners':{
                'over_6.5':1.33,'under_6.5':3.15,
                'over_7.5':1.60,'under_7.5':2.25,
                'over_8.5':2.07,'under_8.5':1.70,
                'over_9.5':2.77,'under_9.5':1.42,
                'arg_over_2.5':1.33,'arg_over_3.5':1.78,'arg_under_3.5':1.95,
                'ing_over_2.5':1.18,'ing_over_3.5':1.45,'ing_under_3.5':2.62,
            }},
        ('España',      'Argentina'):           {'c1':2.42,'cx':2.90,'c2':3.45,'hc':{
                'esp_-1':5.20,'esp_+1':1.34,'arg_+1':1.60,'arg_-1':8.25},
            'totals':{
                'over_0.5':1.10,'over_1.5':1.44,'over_2.5':2.27,'over_3.5':4.10,
                'under_1.5':2.85,'under_2.5':1.65,'under_3.5':1.24,
                'esp_over_0.5':1.31,'esp_over_1.5':2.47,'esp_over_2.5':5.50,
                'esp_under_1.5':1.50,
                'arg_over_0.5':1.47,'arg_over_1.5':3.10,'arg_over_2.5':7.10,
                'arg_under_1.5':1.34,
                'primera_mit_over_0.5':1.55,'primera_mit_over_1.5':2.30,
                'primera_mit_under_0.5':2.40,
                'remates_over_17.5':1.12,'remates_over_18.5':1.19,'remates_over_19.5':1.28,
                'remates_over_20.5':1.42,'remates_over_21.5':1.60,'remates_over_22.5':1.82,
                'remates_over_23.5':2.12,
                'remates_under_21.5':2.27,'remates_under_22.5':1.93,
                'esp_rem_over_8.5':1.10,'esp_rem_over_9.5':1.19,'esp_rem_over_10.5':1.33,
                'esp_rem_over_11.5':1.53,'esp_rem_over_12.5':1.83,'esp_rem_over_13.5':2.27,
                'arg_rem_over_6.5':1.12,'arg_rem_over_7.5':1.23,'arg_rem_over_8.5':1.42,
                'arg_rem_over_9.5':1.70,'arg_rem_over_10.5':2.15,
                'tiros_over_6.5':1.27,'tiros_over_7.5':1.50,'tiros_over_8.5':1.87,'tiros_over_9.5':2.45,
                'tiros_under_7.5':2.47,'tiros_under_8.5':1.87,
                'esp_tiros_over_2.5':1.15,'esp_tiros_over_3.5':1.40,'esp_tiros_over_4.5':1.87,
                'esp_tiros_over_5.5':2.70,'esp_tiros_under_4.5':1.88,
                'arg_tiros_over_2.5':1.27,'arg_tiros_over_3.5':1.67,'arg_tiros_over_4.5':2.45,
                'arg_tiros_under_3.5':2.12,
                'tarjetas_over_1.5':1.11,'tarjetas_over_2.5':1.32,'tarjetas_over_3.5':1.72,
                'tarjetas_over_4.5':2.42,'tarjetas_under_3.5':2.05,'tarjetas_under_4.5':1.52,
                'esp_tar_over_0.5':1.22,'esp_tar_over_1.5':1.95,
                'arg_tar_over_1.5':1.39,'arg_tar_over_2.5':2.15,
                'faltas_over_22.5':1.28,'faltas_over_23.5':1.39,'faltas_over_24.5':1.53,
                'faltas_over_25.5':1.70,'faltas_over_26.5':1.93,
                'penales_si':0,'prorroga_si':0,
                'esp_copa':1.70,'arg_copa':2.22,
            },
            'btts_si':1.87,'btts_no':1.87,
            'corners':{
                'over_6.5':1.40,'under_6.5':2.80,
                'over_7.5':1.75,'under_7.5':2.00,
                'over_8.5':2.32,'under_8.5':1.57,
                'over_9.5':3.20,'under_9.5':1.32,
                'esp_over_2.5':1.18,'esp_over_3.5':1.45,'esp_over_4.5':2.00,
                'arg_over_2.5':1.45,'arg_over_3.5':2.07,'arg_over_4.5':3.30,
            }},
        # ── Octavos de final ──
