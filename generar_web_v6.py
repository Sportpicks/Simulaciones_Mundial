...
<div id="tg-float" style="position:fixed;bottom:20px;right:20px;z-index:9999;
  background:linear-gradient(135deg,#0088cc,#005f8f);border-radius:16px;
  padding:14px 18px;box-shadow:0 4px 20px rgba(0,136,204,.5);
